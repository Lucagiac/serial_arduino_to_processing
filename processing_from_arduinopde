...
// INTRODUCTION
// this sketch takes values from Arduino and maps them to a simple game. you have to push the static ball with the moving ball from the red to the green area.
